        ...
        <div className="car-cards">
            <div className="card">
                ...
                <div className="info">
                    ...
                    <h4>Starting from {props.cars[0].price}</h4>
                   <div className="buy-div"> <button className='buy' id='911 turbo s' onClick={props.handleClick}  >Purchase</button>
                </div> </div>
            </div>
            <div className="card">
                <img src={cayenne} alt="" />
                <div className="info">
                    ...
                    <h4>Starting from {props.cars[1].price}</h4>
                    <div className="buy-div"><button className='buy' id='cayenne' onClick={props.handleClick}  >Purchase</button>
                </div> </div>
            </div>
            <div className="card">
                <img src={boxster} alt="" />
                <div className="info">
                    ...
                    <h4>Starting from {props.cars[2].price}</h4>
                   <div className="buy-div"> <button className='buy' id='boxster' onClick={props.handleClick}  >Purchase</button>
                </div> </div>
            </div>
            <div className="card">
                ...
                <div className="info">
                    ...
                    <h4>Starting from {props.cars[3].price}</h4>
                   <div className="buy-div"> <button className='buy' id='panamera' onClick={props.handleClick}  >Purchase</button>
                </div> </div>
            </div>
            <div className="card">
                <img src={taycan} alt="" />
                <div className="info">
                    ...
                    <h4>Starting from {props.cars[4].price}</h4>
                    <div className="buy-div"><button className='buy' id='taycan' onClick={props.handleClick}  >Purchase</button>
                </div> </div>
            </div>
        </div> 
    </div>
